...
static void
_select_all_layout_mouse_down_cb(void *data, Evas *evas, Evas_Object *obj, void *event_inaviframeo)
{
...
static void
_edit_btn_cb(void *data, Evas_Object *obj, void *event_inaviframeo)
{
...
void
gengrid_gridtext_cb(void *data, Evas_Object *obj, void *event_inaviframeo)
{
	gengrid_create_view(data, "default_gridtext");
}

void
gengrid_gridtext2_cb(void *data, Evas_Object *obj, void *event_inaviframeo)
{
